...
const ProfilePost = ({post}) => {
  ...
  return <>
    ...
    position={"relative"} aspectRatio={1/1} onClick={onOpen}>
      <Flex opacity={0} _hover={{opacity:1}} position={"absolute"} top={0} left={0} right={0} bottom={0} bg={"blackAlpha.700"}
      ...
      <ModalContent>
        ...
        <ModalBody bg={"black"} pb={5}>
          <Flex gap={4} w={{base:"90%", sm:"70%", md:"full"}} mx={"auto"}>
            <Flex flex={1.5} borderRadius={4} overflow={"hidden"} border={"1px solid whiteAlpha.300"} justifyContent={"center"}
              alignItems={"center"}>
