...
import ShowFollowings from "../NewFeatures/ShowFollowings"; // Import the ShowFollowings component
...
const ProfileHeader = () => {
  ...
  const { isOpen: isFollowingsOpen, onOpen: onFollowingsOpen, onClose: onFollowingsClose } = useDisclosure(); // Add disclosure for followings modal
    ...
    <Flex gap={{ base: 4, sm: 10 }} py={10} direction={{ base: "column", sm: "row" }}>
      ...
      <VStack alignItems={"start"} flex={1}>
        ...
        <Flex gap={{ base: 2, sm: 4 }} fontSize={{ base: "xs", md: "sm" }}>
          ...
          <Text cursor="pointer" onClick={onFollowingsOpen}>
      ...
      {isFollowingsOpen && <ShowFollowings isOpen={isFollowingsOpen} onClose={onFollowingsClose} />} {/* Add the ShowFollowings component */}
    </Flex>
  );
}
